...
class trans6 extends StatelessWidget{
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('طلب تحويل من كلية لاخرى', textAlign: TextAlign.right,
          style: TextStyle(
...
class _DataFormState extends State<DataForm> {
  ...
  final TextEditingController changecoulController = TextEditingController();
  final TextEditingController changetypeController = TextEditingController();
  ...
  Future<void> sendData() async {
    final response = await http.post(
      ...
      body: jsonEncode(<String, dynamic>{
        ...
        'changecoul':changecoulController,
        'changetype':changetypeController,
    ...
    return SingleChildScrollView(
      child: Column(
        ...
        children: [
          ...
          Text(':ارغب بالتحويل الى كلية', style: TextStyle(fontSize: 16)),
          TextField(
            controller: changecoulController,
            textAlign: TextAlign.right,
            decoration: InputDecoration(
              border: OutlineInputBorder(),
              hintText: 'أدخل الكلية الذي ترغب بالتحويل اليها',
            ),
          ),
          SizedBox(height: 16),

          Text(': الى التخصص', style: TextStyle(fontSize: 16)),
          TextField(
            controller:changetypeController,
            textAlign: TextAlign.right,
            decoration: InputDecoration(
              border: OutlineInputBorder(),
              hintText: 'أدخل التخصص الذي ترغب بالتحويل اليه',
            ),
          ),
          SizedBox(height: 16),
